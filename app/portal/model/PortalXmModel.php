...
class PortalXmModel extends Model
{
    ...
    public function adminAddArticle($data, $categories)
    {
        ...
        $data['fenxi'] = isset($data['fenxi']) ? cmf_replace_content_file_url(htmlspecialchars_decode($data['fenxi'])
        ) : '';
        $data['jieshao'] = isset($data['jieshao']) ?  cmf_replace_content_file_url(htmlspecialchars_decode($data['jieshao'])) : '';
        $data['liucheng'] = isset($data['liucheng']) ?  cmf_replace_content_file_url(htmlspecialchars_decode($data['liucheng'])) : '';
        $data['tiaojian'] = isset($data['tiaojian']) ?  cmf_replace_content_file_url(htmlspecialchars_decode($data['tiaojian'])) : '';
