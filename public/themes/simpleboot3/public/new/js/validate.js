...
//           $("#Name1").focus(); 
//           return false; 
//       }else if (tel=="" || (tel != "" && !mobile.test(tel) && !phone.test(tel))) {
...
//           $.ajax({
//           type: "POST",
//           url: "{:cmf_url('portal/xm/liuyan')}",
//           data: {name:username,sex:sex,email:email,jine:jine,tel:tel,url:url4,mag:msg,address:address},
//           dataType: "json",
