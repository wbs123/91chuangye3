...
if (\think\Request::instance()->isMobile()) {
    if($_SERVER['HTTP_HOST'] == '91.tongren2019.com' || $_SERVER['HTTP_HOST'] == 'www.91.tongren2019.com'){
        header("location:".$http."m91.tongren2019.com".$_SERVER['REQUEST_URI']);exit;
    }
}else{
    if($_SERVER['HTTP_HOST'] == 'm91.tongren2019.com'){
        header("location:".$http."91.tongren2019.com".$_SERVER['REQUEST_URI']);exit;
    }
}
